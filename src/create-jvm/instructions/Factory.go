...
import (
	...
	"create-jvm/instructions/comparisons"
	"create-jvm/instructions/constants"
	"create-jvm/instructions/control"
	"create-jvm/instructions/conversions"
	"create-jvm/instructions/extended"
